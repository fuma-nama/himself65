---
title: How to make your NPM package work? (01)
createdAt: 2024-04-18
description: A guide to publishing NPM packages that work across multiple JavaScript runtimes like Node.js, Deno, Bun, and more.
---
...
However, the difficulty is that there needs to be a document to list which one is _stable_ or _experimental_ as nowadays everything is experimental, but everyone uses it in JS.
