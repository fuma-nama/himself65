...
export default async function BlogPostPage({
  ...
  return (
    <div className="min-h-screen bg-white">
      <header className="border-b border-gray-200" aria-label="Header">
        <div className="max-w-4xl mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center space-x-8">
            <div className="flex items-center space-x-2">
              <h1 className="text-lg font-medium">Alex Yang</h1>
            </div>
      ...
      <footer className="border-t border-gray-200 mt-16" aria-label="Footer">
        <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          <div className="text-center text-xs text-gray-400">
            Powered by <span className="text-blue-600">waku</span>
          </div>
        </div>
      </footer>
    </div>
